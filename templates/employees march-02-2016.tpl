                        ...
                        <div class="row">
                            <form role="form" method="post">
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" name="username" class="form-control" value="{$rowRec.username}" required>
                                </div>
                                <div class="form-group col-lg-4">
                                    <label>Password</label>
                                    <input type="password" name="password" class="form-control" value="{$rowRec.password}" required>
                                </div>
                                <div class="form-group col-lg-4">
                                    <label>Remarks</label>
