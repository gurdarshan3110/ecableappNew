            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Pending Report
                        <span style="float:right;margin-top:-6px;"><a class="btn btn-success" href="export-pending-report.php?employee_id={$rowRec.employee_id}&status={$rowRec.status}&subscriber_status={$rowRec.subscriber_status}">Excel Report</a></span>
                    </div>
