...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top top-bg-clr" role="navigation" style="margin-bottom: 0">
            ...
            <div style="width: 10%;float: right;color: #fff;font-size: 16px;padding: 10px 15px;text-align:right;">{$smarty.session.NAME}
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse sidebar-bg">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                             <a href="setup-boxes.php"><img src="images/setup-box.png"> Stb</span></a>
                        </li>
                        <li>
