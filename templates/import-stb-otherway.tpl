            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <b style="text-align:right;"><a href="uploads/import-stb-otherways.csv" target="_blank" class="btn btn-info">Download Sample File</a></b>
                    </div>
                            ...
                            <form role="form" method="post" data-parsley-validate>
                                <div class="form-group col-lg-4">
                                   <label for="name">Upload File :</label> 
                                    ...
                                    <a href="import-stb-otherway.php" class="btn btn-default">Cancel</a>
                         		</div> <!-- .actions -->
            			    </form>
		            </div> <!-- .widget-content -->		
	                </div> <!-- .widget --><!-- .widget -->	
