            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse sidebar-bg">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="headoffice-collections.php"><img src="images/Head-office.png"> Collections</span></a>
                        </li>
                        <li>
                            <a href="sms-recharge.php"><img src="images/Head-office.png"> Sms Recharge</span></a>
                        </li>
                        <li>
                        ...
                        <li>
                             <a href="pending-report.php"><img src="images/collection-report.png"> Pending Report</span></a>
                        </li>
                        <li>
                             <a href="collection-report.php"><img src="images/collection-report.png"> Collection Report</span></a>
                        </li>
                        <li>
                             <a href="permission.php"><img src="images/collection-report.png"> Permissions</span></a>
                        </li>
                        <li>
                             <a href="sms-settings.php"><img src="images/collection-report.png"> Sms Settings</span></a>
                        </li>
                        <li>
                             <a href="change-password.php"><img src="images/icon-dashboard.png"> Change Password</span></a>
                        </li>
                        <li>
                             <a href="profile.php"><img src="images/icon-dashboard.png"> Edit Profile</span></a>
                        </li>
                        {/if}
