                                    ...
                                    <div class="col-lg-12" id="payment_mthd" style="display:none;">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="table-data">
                                                <label>STB No.</label>
                                                <input type="text" name="stb_no[]" id="stb_no1" class="form-control" value="{$rowRec.ct_no}">
                                            </div>
                                            <div class="table-data">
                                                <label>S.No.</label>
                                                <input type="text" name="vc_no[]" id="vc_no" class="form-control" value="{$rowRec.ct_no}">
