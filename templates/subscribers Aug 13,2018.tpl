                        ...
                        <div class="row">
                            <form role="form" method="post" data-parsley-validate>
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" name="identity_name" class="form-control" value="{$rowRec.identity_name}" required>
                                </div>
                                <div class="form-group col-lg-4" >
                                        <label>
                                ...
                                <div class="form-group col-lg-4">
                                    <label>Mobile2 </label>
                                    <input type="text" name="mobile_no" data-parsley-type="number" data-parsley-trigger="keyup" data-parsley-minlength="10" data-parsley-maxlength="10" class="form-control" value="{$rowRec.mobile_no}" required>
                                </div>
                                <div class="form-group col-lg-4">
                                    <label>Email </label>
                                    <input type="text" name="email" class="form-control" value="{$rowRec.email}" required>
                                </div>
                                <div class="form-group col-lg-4">
                                    <label>Address</label>
                                ...
                                <div class="form-group col-lg-4">
                                    <label>Id Type </label>
                                    <input type="text" name="id_type" class="form-control" value="{$rowRec.id_type}" required>
                                </div>
                                <div class="form-group col-lg-4">
                                    <label>Id No </label>
                                    <input type="text" name="id_no" class="form-control" value="{$rowRec.id_no}" required>
                                </div>
                                {if $group eq ''}
                                <div class="form-group col-lg-4">
                                    <label>Opening Balance </label>
                                    <input type="text" name="opening_balance" class="form-control" value="0" required>
                                </div>
                                {/if}
                                <div class="form-group col-lg-4">
                                    <label>Installed By </label>
                                    <input type="text" name="installed_by" class="form-control" value="{$rowRec.installed_by}" required>
                                </div>
                                ...
                                <div class="col-lg-12" id="payment_mthd" style="display:block;">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-sm-3">
                                            <label>Package</label>
                                            <select id="package_id1" onchange="TotAmt(1);"  name="package_id[]" class="form-control">
                                                <option value="">-Please Select-</option>
                                                {$packageArray}
                                            </select>
                                        </div>
