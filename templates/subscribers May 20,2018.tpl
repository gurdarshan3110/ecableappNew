                    ...
                    <div class="panel-body">
                        <div class="row">
                            <form role="form" method="post" data-parsley-validate>
                                ...
                                <div class="form-group col-lg-4">
                                    <label>Mobile2 </label>
                                    <input type="text" name="mobile_no" class="form-control" value="{$rowRec.mobile_no}" required>
                                </div>
                                <div class="form-group col-lg-4">
                                    <label>Email </label>
