                        ...
                        <div class="row">
                            <form role="form" method="post">
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <input type="radio" name="subscriber_status" {if $rowRec.subscriber_status eq ''} checked="checked"{/if} value="">&nbsp;All
                                    <input type="radio" name="subscriber_status" {if $rowRec.subscriber_status eq 'A'} checked="checked"{/if} value="A">&nbsp;Active
                                    <input type="radio" name="subscriber_status" {if $rowRec.subscriber_status eq 'D'} checked="checked"{/if} value="D">&nbsp;Deactive
                                </div>
                                <div class="form-group col-lg-3">
                                    <label style="width:100%">&nbsp;</label>
                                    <button type="submit" name="submit" class="btn btn-primary">Submit</button>
                                    <a href="/pending-report.php" class="btn btn-default">Reset</a>
                                </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Pending Report
                        <span style="float:right;margin-top:-6px;"><a class="btn btn-success" href="export-pending-report.php?employee_id={$rowRec.employee_id}&status={$rowRec.status}&subscriber_status={$rowRec.subscriber_status}&unit_id={$rowRec.unit_id}">Excel Report</a></span>
                    </div>
