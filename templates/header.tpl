    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top top-bg-clr" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header" style="width:19%">
                ...
                <a class="navbar-brand logo-bar" href="index.html" style="padding:0px !important;"><img src="images/logo3.png" style="width: 85%;padding: 5px 5px;"></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse sidebar-bg">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                             <a href="franchise-master.php"><img src="images/edit-profile.png"> Franchise Master</span></a>
                        </li>
                        <li>
                        ...
                        <li>
                                 <a href="import-stb-otherway.php"><img src="images/import-settop-box.png">Bulk STB Import</span></a>
                        </li>
                        <li>
                                 <a href="setup-boxes.php"><img src="images/setup-box.png"> STB Master</span></a>
                        </li>
                        <li>
                        ...
                        <li>
                             <a href="sms-utility.php"><img src="images/sms-utility.png"> SMS Utility</span></a>
                        </li>
                        <li>
                             <a href="monthly-collections.php"><img src="images/collection.png"> Collections</span></a>
                        </li>
                        <li>
                             <a href="pending-report.php"><img src="images/pending-report.png"> Pending Report</span></a>
                        </li>
                        <li>
                        ...
                        {if $smarty.session.USER_TYPE eq 'E'}
                            ...
                            <li>
                                 <a href="import-stb.php"><img src="images/import-settop-box.png">Bulk STB Import</span></a>
                            </li>
                            {/if}
                            ...
                            {/if}
                            {if '16_V'|in_array:$smarty.session.pass}
                            <li>
                                 <a href="pending-report.php"><img src="images/pending-report.png"> Pending Report</span></a>
                            </li>
                            {/if}
