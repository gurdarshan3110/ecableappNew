...
if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['submit'])){
    if($_POST['typo']=='B'){
        ...
        if($balSms>0){
            ...
            $msg="Payment of ".$amount." has been recieved for connection of Rs ".$_SESSION['HEADOFFICE_NAME'];
...
$i  = 1;
$pagin_recs = "";
$pagin_recs = '<input type="hidden" value="" id="checkStatus" name="checkStatus"><thead><tr><th width="10%">Receipt No</th><th width="35%">Subscriber</th><th width="10%">Phone No</th><th width="15%">Collection</th><th width="15%">Date</th><th>Action';
/*
