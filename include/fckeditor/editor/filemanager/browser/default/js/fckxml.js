...
FCKXml.prototype.LoadUrl = function( urlToCall, aORcFunctionPointer )
{
	var oFCKXml = this ;

	var bAORc = ( typeof(aORcFunctionPointer) == 'function' ) ;

	var oXmlHttp = this.GetHttpRequest() ;

	oXmlHttp.open( "GET", urlToCall, bAORc ) ;
