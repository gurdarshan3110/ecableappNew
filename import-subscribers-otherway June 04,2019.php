                        ...
                        //Code For Sub Area
                            ...
                            if(empty($subscriber)){
                                $subscriberArray = array(
                                                        ...
                                                        'CONNECTION_DATE'  =>$objMisc->changeDateFormat($data[16]),
                                                        'OPENING_BALANCE'  =>addslashes($data[17]),
                                                        'AMOUNT'           =>addslashes($data[17]),
                                                        'UNIT_ID'          =>$subArea,
                                                        'CUSTOMER_ID'      =>addslashes($uniCustId),
                                                        'PHONE_NO'         =>addslashes($data[7]),
                                                        'MOBILE_NO'        =>addslashes($data[8]),
                                                        'EMAIL'            =>addslashes($data[9]),
                                                        'ID_TYPE'          =>addslashes($data[10]),
                                                        'ID_NO'            =>addslashes($data[11]),
                                                        'IDENTITY_NAME'    =>addslashes($data[12]),
                                                        'INSTALLED_BY'     =>addslashes($data[13]),
                                                        'RELATION'         =>addslashes($data[14]),
                                                        'RELATIVE'         =>addslashes($data[15]),
                                                        'REMARKS'          =>addslashes($data[18]),
