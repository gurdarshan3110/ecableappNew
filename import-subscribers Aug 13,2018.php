            ...
            while(!feof($fp)) {
                while (($data = fgetcsv($fp, 10000, ",")) !== FALSE) { 
                        ...
                        //Code For Setup Boxes
                            ...
                            $subscription=$objMisc->GiveValue(" HEADOFFICE_ID='$_SESSION[HEADOFFICE]' AND STB_NO='$data[17]'",'SUBSCRIPTION_ID','subscriptions');
                            if($subscription=='' && ($data[17]!='' || $data[17]!=0)){
                                $subscriptionArray = array( 'HEADOFFICE_ID'          =>$_SESSION['HEADOFFICE'],
                                                            
                                                            'STB_NO'           =>addslashes($data[17]),
                                                            'CARTON_NO'           =>addslashes($data[16]),
                        ...
                        $package_id=$objMisc->GiveValue(" HEADOFFICE_ID='$_SESSION[HEADOFFICE]' AND PACKAGE_TYPE='P' AND NAME='$data[11]'",'PACKAGE_ID','package_master');
                        if($package_id=='' && ($data[11]!='' || $data[11]!=0)){
                            $packageArray = array( 'HEADOFFICE_ID'  =>$_SESSION['HEADOFFICE'],
                                                'NAME'              =>addslashes($data[11]),
                        ...
                        /*Code For Subscriber Insertion
                            ...
                            $uniCustId=$data[6];
                            $subscriber=$objMisc->GiveValue(" HEADOFFICE_ID='$_SESSION[HEADOFFICE]' AND NAME='$data[3]' AND MSO_ID='$data[5]' AND CUSTOMER_ID='$uniCustId'",'SUBSCRIBER_ID','subscribers');
                            if(empty($subscriber)){
                                $subscriberArray = array('HEADOFFICE_ID'          =>$_SESSION['HEADOFFICE'],
                                                        'NAME'             =>addslashes($data[3]),
                                                        'PAYMENT_METHOD'   =>'P',
                                                        'ADDRESS'          =>addslashes($data[4]),
                                                        'CONNECTION_DATE'  =>$objMisc->changeDateFormat($data[7]),
                                                        'OPENING_BALANCE'  =>addslashes($data[8]),
                                                        'AMOUNT'           =>addslashes($data[9]),
                                                        'UNIT_ID'          =>$subArea,
                                                        'CUSTOMER_ID'      =>addslashes($uniCustId),
                                                        'PHONE_NO'         =>addslashes($data[13]),
                                                        'MOBILE_NO'        =>addslashes($data[14]),
                                                        'EMAIL'            =>addslashes($data[15]),
                                                        ...
                                                        'REMARKS'          =>addslashes($data[12]),
                                                        'MSO_ID'           =>addslashes($data[5]),
                                                        'ADDED_BY'         =>$_SESSION['USER_ID'],
                                                        'ADDED_TIME'       =>date('Y-m-d H:i:s'),
                                                            );
                        ...
                        //Code For Setup Box Partition
                            if($subscription=='' && ($data[17]=='' || $data[17]==0)){
                                $subscriptionArray = array( 'HEADOFFICE_ID'    =>$_SESSION['HEADOFFICE'],
                                                            'STB_NO'           =>'DUM-'.$subscriber.'-'.$_SESSION['HEADOFFICE'].'-'.rand(1111,9999),
                                                            'STATUS'           =>'B',
                                                            'ADDED_BY'         =>'1',
                                                            'ADDED_TIME'       =>date('Y-m-d H:i:s'),
                                                            );
                            ...
                            if($setupBox==''){
                                $laCarteId=$objMisc->GiveValue(" HEADOFFICE_ID='$_SESSION[HEADOFFICE]' AND PACKAGE_TYPE='L' AND NAME='$data[28]'",'PACKAGE_ID','package_master');
                                if($laCarteId=='' && ($data[28]!='' || $data[28]!=0)){
                                    $packageArray = array( 'HEADOFFICE_ID'  =>$_SESSION['HEADOFFICE'],
                                                        'NAME'              =>addslashes($data[28]),
                                                        'PARENT_CHARGES'    =>$data[29],
                                                        'PACKAGE_TYPE'      =>'L',
                                                        'ADDED_BY'          =>$_SESSION['USER_ID'],
                                                        'ADDED_TIME'        =>date('Y-m-d H:i:s'),
                                                        );
