            ...
            while(!feof($fp)) {
                while (($data = fgetcsv($fp, 10000, ",")) !== FALSE) { 
                        ...
                        /*Code For Subscriber Insertion
                            ...
                            $subscriber=$objMisc->GiveValue(" HEADOFFICE_ID='$_SESSION[HEADOFFICE_ID]' AND NAME='$data[4]' AND CUSTOMER_CODE='$data[6]' AND CUSTOMER_ID='$data[7]'",'SUBSCRIBER_ID','subscribers');
                            if(empty($subscriber)){
