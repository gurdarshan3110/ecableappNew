...
if(!empty($classRecord)){ 
    ...
    foreach ($classRecord as $k => $rowRec){    
        $prevDebit=$objMisc->GiveValue(" SUBSCRIBER_ID='$rowRec[subscriber_id]' AND STATUS='A' AND AMOUNT_TYPE='D' AND MONTH(MONTH_DATE)<='$lastMonth' AND YEAR(MONTH_DATE)='$lastYear'",'SUM(AMOUNT)','monthly_charges');
        $prevCredit=$objMisc->GiveValue(" SUBSCRIBER_ID='$rowRec[subscriber_id]' AND STATUS='A' AND AMOUNT_TYPE='C' AND MONTH(MONTH_DATE)<='$lastMonth' AND YEAR(MONTH_DATE)='$lastYear'",'SUM(AMOUNT)','monthly_charges');
        $prevDiscount=$objMisc->GiveValue(" SUBSCRIBER_ID='$rowRec[subscriber_id]' AND STATUS='A' AND AMOUNT_TYPE='C' AND MONTH(MONTH_DATE)<='$lastMonth' AND YEAR(MONTH_DATE)='$lastYear'",'SUM(DISCOUNT)','monthly_charges');
