...
$wherethis = " 1=1 ORDER BY `HEADOFFICE_ID` DESC";
$classRecord = $objMisc->getAllRecordsPaging("*","headoffice_master",$wherethis);
$i  = 1;
$pagin_recs = "";
$pagin_recs = '<input type="hidden" value="" id="checkStatus" name="checkStatus"><thead><tr><th width="25%">Headoffice Name</th><th width="45%">Description</th><th>Action';
       ...
       foreach ($classRecord[1] as $k => $rowRec)
        {       
           ...
           // echo $_SESSION['USER_ID'];
                ...
                $pagin_recs .='<a href="headoffice.php?id='.base64_encode($rowRec['headoffice_id']).'&page='.$_GET['page'].'"><img src="images/edit-btn.gif"  alt="Edit" title="Edit"  border="0"></a>&nbsp;';
                
                $pagin_recs .='<input type="checkbox" name="artCatCheckbox[]" value="'.$rowRec['headoffice_id'].'" id="artCatCheckbox_'.$i.'">&nbsp;';
