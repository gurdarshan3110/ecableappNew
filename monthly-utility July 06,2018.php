...
if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['submit'])){
    ...
    $subscribers=" SELECT B.`SUBSCRIBER_ID`,B.`PACKAGE_ID`,P.`PARENT_CHARGES`,B.STB_ID FROM `stb_box` B JOIN `package_master` P ON P.`PACKAGE_ID`=B.`PACKAGE_ID` WHERE  B.`STATUS`='A' AND B.`HEADOFFICE_ID`='$_SESSION[HEADOFFICE]'";
