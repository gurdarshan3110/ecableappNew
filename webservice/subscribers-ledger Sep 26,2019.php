...
require_once("helper.php");
    ...
    foreach ($collection as $k => $valu) {
        ...
        $discount=$objMisc->GiveValue("AMOUNT_TYPE='C' AND MONTH_DATE='$valu[month_date]' AND SUBSCRIBER_ID='$subscriber_id' AND AMOUNT!='0' AND STATUS='A'",'SUM(DISCOUNT)','monthly_charges');
