...
*/
                ...
                $phones=$objMisc->GiveValue("FRANCHISE_ID='$franchise_id'",'MOBILE_NO','franchise_master');
                $currentMonth=date('m');
                if($currentMonth<=3){
                ...
                $sno=$objMisc->GiveValue("FRANCHISE_ID='$franchise_id' AND AMOUNT_TYPE='C' AND DATE(MONTH_DATE) BETWEEN '$startDate' AND '$endDate'",'MAX(SNO)','monthly_charges')+1;
            ...
            if(!empty($lastId)){
                ...
                if($balSms>0){
                    ...
                    $franchiseName=$objMisc->GiveValue("FRANCHISE_ID='$franchise_id'",'NAME','franchise_master');
                    $msg="Thanks for '.$franchiseName.' subscription Rs ".$amount." against Vr. No. ".$receipt_no." Dated  ".$dateRec." And your balance is ".$amtBal.".Complaint No. ".$phones;
