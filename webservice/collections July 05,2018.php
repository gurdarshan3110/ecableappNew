...
require_once("helper.php");
    ...
    switch ($action) {
        case 'Bill';
            ...
            $sno=((!empty($receipt['sno']))?$receipt['sno']+1:'1');
            ...
            $rowArray       = array('HEADOFFICE_ID'         =>$headoffice_id,
                ...
                if(!empty($val)){
                    if($balSms>0){
                        ...
                        $headOfcArr=$objMisc->GiveValue('headoffice_master',"HEADOFFICE_ID='$headoffice_id'");
                        $msg="Payment of ".$amount." has been recieved for connection of ".$headOfcArr['name'];
