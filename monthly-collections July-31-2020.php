...
if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['submit'])){
    ...
    if($canBill=='Y'){    
        if($_POST['typo']=='B'){
            ...
            $sno=$objMisc->GiveValue("HEADOFFICE_ID='$_SESSION[HEADOFFICE]' AND MONTH(MONTH_DATE)='".date('m')."' AND YEAR(MONTH_DATE)='".date('Y')."' AND AMOUNT_TYPE='C'",'MAX(SNO)','monthly_charges')+1;
