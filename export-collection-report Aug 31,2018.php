...
$classRecord = $objMisc->getAllRecords("SUBSCRIBER_ID,MONTH_DATE,RECEIPT_NO,AMOUNT,DISCOUNT,ID,SPECIAL_REMARKS,STATUS",'monthly_charges',$wherethis);
...
$rowArray = array('0'=>'Receipt No','1'=>'Receipt Date','2'=>'Customer Id','3'=>'Customer Code','4'=>'Name','5'=>'Address','6'=>'Receipt Amount','7'=>'Discount','8'=>'Balance','9'=>'Phone No','10'=>'Set Top Boxes');
if ($rowArray){
