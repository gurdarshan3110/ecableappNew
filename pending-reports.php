...
$classRecord = $objMisc->getAllRecordsPagingNew("SELECT S.SUBSCRIBER_ID,M.ADDED_TIME,M.RECEIPT_NO FROM monthly_charges M JOIN `subscribers` S ON S.SUBSCRIBER_ID=M.SUBSCRIBER_ID AND S.STATUS='A' WHERE $wherethis");
...
//echo "hi";exit;
$objMisc->displayPage("header,pending-reports,footer",$smartyVars);
?>
